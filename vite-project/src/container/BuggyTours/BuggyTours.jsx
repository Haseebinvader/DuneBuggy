  ...
  return (
    <div className="app__specialMenu flex__center section__padding" id="menu">
      <div className="app__specialMenu-title">
        <h1 className="headtext__cormorant">Polaris Dube Buggy Tours</h1>
      </div>
      <div className="app__specialMenu-menu" style={{ gap: '2rem' }}>
        {data.filter((item) => item.category === "Buggies").map((item, index) => (
